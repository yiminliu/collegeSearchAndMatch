...
<table id="results" align="center" border="4" cellspacing="2"
	...
	<table>
		<tr>
			<td>搜索指标:<s:property value="searchCriteria" /></td>
		</tr>
		<tr>
			<td><font size="3" color="red"><s:property
				value="numOfSchools" /></font> 所大学</td>
		</tr>
	</table>
	<p>
...
<td align="center"><s:property value="selectivityRank" /></td>-->
	...
	<table align="center" cellspacing="8" cellpadding="2">
		<tr align="center">
			<td>
			<form><input type="button" value="重新搜索"
				onClick="window.location='/CollegeService/fineSearchCHN.jsp'" /></form>
			</td>
			<td>
