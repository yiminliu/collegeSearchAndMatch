...
public class AccountDaoTest extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void testGetAllAccounts(){
		...
		List<SimplifiedAccount> accounts = (List<SimplifiedAccount>)accountDao.getAllAccounts();
		assertNotNull("should not be null", accounts);
		System.out.println("Total number od accounts = " + accounts.size());
		for(SimplifiedAccount account : accounts){ 
	...
	@Test
	public void testGetSimplifiedAccountById(){
		System.out.println("test if the account is returned by searching its ID...");
		Account account = (SimplifiedAccount)accountDao.getAccountById(testAccountId);
		System.out.println("account = " + account.toString());
	...
	public void testGetAccountsByActivityStatus(){
		...
		List<SimplifiedAccount> accounts = (List<SimplifiedAccount>)accountDao.getAccountsByStatus(testStatus);
		assertNotNull("should not be null", accounts);
		for(SimplifiedAccount account : accounts){ 
		    //System.out.println("account = " + account.toString());
		    assertEquals("account should have " + testStatus, testStatus.toUpperCase(), account.getStatus());
		}    
	}
	
	@Test
	public void testGetAccountsByCityParameter(){
		System.out.println("test if the accounts are returned by searching city...");
		List<SimplifiedAccount> accounts = (List<SimplifiedAccount>)accountDao.findByParameter("city", testCity);
		assertNotNull("should not be null", accounts);
		for(SimplifiedAccount account : accounts){ 
		    System.out.println("account = " + account.toString());
