...
<body background="/WEB-INF/static/images/search_bg3.jpg">
  <div class="wide_container">
     <c:choose>
        ...
        <c:otherwise>          
           <div class="page_title_very_wide">Colleges Matching Your Qualifications and Preferences(${fn:length(schoolList)} found)</div>
        </c:otherwise>
     </c:choose>
	...
	<div>
	 <table  class="center" style="margin: 0 auto; cellspacing: 30px; cellpadding: 30px; border-spacing: 50px;">
          <tr>
             <td><a id="schoolHome" href="<spring:url value="/school/home" />" class="button_m"><span style="cellspacing: 30px; cellpadding: 30px;">Home</span></a></td>
             <td ><a id="searchSchool" href="<spring:url value="/school/showMatchEngineForm" />" class="button_m"><span style="cellspacing: 30px; cellpadding: 30px;">Match Engine</span></a></td>
          </tr>
       </table>
     </div>
     </div> <!--content-->
