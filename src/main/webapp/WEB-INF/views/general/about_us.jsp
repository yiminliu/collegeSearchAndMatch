...
<table>
	<tbody>
		<tr>
			<td class="txt05"
				style="border-bottom: 1px dashed rgb(197, 208, 213); padding-bottom: 4px;"
				align="center" height="42" valign="bottom">
			<h2>关于我们</h2>
			</td>
...
<table>
	<tbody>
		<tr>
			...
			九十年代初，我们远涉重洋，来到美国留学深造。数年之后，我们指导儿女选择适合他们的美国大学。 而今，
			我们希望用我们对美国大学教育及升学文化的深入了解与亲身感受来帮助你们--未来新一代的留美学子，
			选择并进入适合你们的美国大学,丰富你们的学识与人生。 用我们的热情和能力实现你们的留学理想是我们的目标和宗旨。</td>
		</tr>
	</tbody>
</table>
</body>
